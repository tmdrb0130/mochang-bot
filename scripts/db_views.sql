...
--   v_outputs : 생성문 1건 = 1행. 초안 아이디어 + 문항 이름 + 글자수 + 생성 시각 + 본문. 초안별·문항 순서로 정렬.
...
SELECT
  ...
  CASE g.question_id
    ...
    WHEN 'q8' THEN '본인 역량' WHEN 'q10' THEN '홍보 문구' ELSE g.question_id END AS 문항이름,
  g.kind                     AS 종류,
  g.chars                    AS 글자수,
...
ORDER BY d.updated_at DESC,
  CASE g.question_id WHEN 'q1' THEN 1 WHEN 'q2' THEN 2 WHEN 'q3_1' THEN 3 WHEN 'q3_2' THEN 4
                     WHEN 'q4_1' THEN 5 WHEN 'q4_2' THEN 6 WHEN 'q8' THEN 7 WHEN 'q10' THEN 8 ELSE 9 END, g.id;
